...
#define STRING_CONFIG_H_AUTHOR "(Tal Ziv based on thisiskeithb examlpe config, Ender-3)" // Who made the changes.
//#define SHOW_BOOTSCREEN //TAL
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5 //TAL
